...
cd simulation
mv car_h.py car.py
echo The chosen AV model is Aware and Opportunistic
echo
cd ..

#different density simulations
echo Low density regime: 0.08
python3 nagel.py low_density_aware_oppo.txt 24 5 5 4 3 1 0.6 0 0.4 
echo 
echo Simultation is complete!
echo Critical density regime: 0.2
python3 nagel.py crit_density_aware_oppo.txt 60 5 5 4 3 1 0.6 0 0.4 
echo 
echo Simultation is complete!
echo High density regime: 0.6
python3 nagel.py high_density_aware_oppo.txt 180 5 5 4 3 1 0.6 0 0.4 
echo 
echo Simultation is complete!
echo
...
echo
cd ..
echo All simulation cases for Aware and Oppo model is over
