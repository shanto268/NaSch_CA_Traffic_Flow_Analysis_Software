...
cd simulation
mv car_nh.py car.py
echo "The chosen AV model is Base Scenario (Smaller Headway)"
echo
cd ..

#different density simulations
echo Low density regime: 0.08
python3 nagel.py low_density_base_hv_hway.txt 24 5 4 4 3 0.6 0.6 0.4 0.4
echo 
echo Simultation is complete!
echo Critical density regime: 0.2
python3 nagel.py crit_density_base_hv_hway.txt 60 5 4 4 3 0.6 0.6 0.4 0.4
echo 
echo Simultation is complete!
echo High density regime: 0.6
python3 nagel.py high_density_base_hv_hway.txt 180 5 4 4 3 0.6 0.6 0.4 0.4
echo 
echo Simultation is complete!
echo
