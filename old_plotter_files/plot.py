...
with open(r"dyout1.txt", "r+") as f:     #fr change
    a = f.read()

with open(r"dyout1.txt", "w+") as f:     #fr change
...
with open('dyout1.txt','r') as csvfile:
...
#print(updates)    
                                ...
                                #fig names
fig1 = "v6/dy/trigcondv.pdf"    
fig2 = "v6/dy/trigcondav.pdf"
fig3 = "v6/dy/lcrate.pdf"
fig4 = "v6/dy/numlane.pdf"
fig5 = "v6/dy/trigstatus.pdf"
fig6 = "v6/dy/fddata.pdf"
fig7 = "v6/dy/newflowfd.pdf"
fig8 = "v6/dy/fd-rv.pdf"
fig9 = "v6/dy/fd-av.pdf"
fig10 = "v6/dy/fdfit.pdf"
fig11 = "v6/dy/rhov.pdf"
fig12 = "v6/dy/summary/resultdv=2av=15.pdf"
fig13 = "v6/dy/fdfitrv.pdf"
fig14 = "v6/dy/fdfitav.pdf"
fig15 = "v6/dy/drvdav.pdf"
fig16 = "v6/dy/fdrvav.pdf"                       
                                     #graph labels
...
plt.xlabel('density')
plt.ylabel('flow')
plt.title('Fundamental diagram: ' + str1)
plt.savefig(fig6)
plt.show()
...
plt.xlabel('density')
plt.ylabel('flow')
plt.title('RV Fundamental diagram: ' + str1)
plt.savefig(fig8)
plt.show()
...
plt.xlabel('density')
plt.ylabel('flow')
plt.title('AV Fundamental diagram: ' + str1)
plt.savefig(fig9)
plt.show()
...
plt.scatter(x,y,color = 'mediumblue', s=3, marker = ".", label = '100% data')
plt.legend()
plt.xlabel('density')
plt.ylabel('flow')
plt.title('Fundamental diagram: ' + str1)
...
plt.scatter(xrv,yrv,color = 'mediumblue', s=3, marker = ".", label = '100% data')
plt.legend()
plt.xlabel('density')
plt.ylabel('flow')
plt.title('RV Fundamental diagram: ' + str1)
...
plt.scatter(xav,yav,color = 'mediumblue', s=3, marker = ".", label = '100% data')
plt.legend()
plt.xlabel('density')
plt.ylabel('flow')
plt.title('AV Fundamental diagram: ' + str1)
...
pdfs = [fig1, fig2, fig3, fig4,fig5, fig6,fig7, fig8,fig9, fig10,fig11, fig13, fig14, fig15, fig16 ]
