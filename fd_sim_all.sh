...
echo
. fd_sim_case.sh fd_base_hway.txt 15 5 4 4 3 0.6 0.6 0.4 0.4 car_nh.py

echo Base Scenario HV Like Model Simulation 
echo
. fd_sim_case.sh fd_base_hvlike.txt 15 5 3 3 3 0.6 0.6 0.4 0.4 car_nh.py

echo Opprtunistic Model Simulation
echo
. fd_sim_case.sh fd_oppo.txt 15 5 4 4 3 1 0.6 0 0.4 car_nh.py
